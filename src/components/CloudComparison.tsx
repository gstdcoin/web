    ...
    <section className="py-20 bg-gradient-to-b from-white to-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-light max-w-3xl mx-auto mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <Card className="bg-white/40 backdrop-blur-md border-white/10 hover:border-red-500/30 h-full">
              <CardHeader>
                <CardTitle className="text-2xl text-light-bg flex items-center justify-between">
                  {comparison?.cloud?.title || 'Облачные провайдеры'}
                  <Badge className="bg-red-500/20 text-red-600 border-red-500/30">Дорого</Badge>
                </CardTitle>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Card className="bg-white/60 backdrop-blur-md border-amber-500/30 hover:border-amber-500/50 shadow-lg h-full">
              <CardHeader>
                <CardTitle className="text-2xl text-light-bg flex items-center justify-between">

    ...
    <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4">
            ...
            <Card className="bg-white/40 backdrop-blur-md border-white/10 hover:border-amber-500/30 h-full">
              <CardHeader>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <CardTitle className="text-2xl text-light-bg">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Card className="bg-white/60 backdrop-blur-md border-amber-500/30 shadow-lg max-w-3xl mx-auto">
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <Badge className="mt-2 bg-purple-500/20 text-purple-600 border-purple-500/30">
